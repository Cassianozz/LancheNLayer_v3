...
public class Main {
    ...
    public static void atualizarLanche() throws IOException {
        ...
        System.out.println("Digite o caminho atual da imagem (arquivo): ");
        String caminhoImagem = scanner.nextLine();

        System.out.println("Digite a nova pasta destino: ");
        String novaPasta = scanner.nextLine();

        Lanche lanche = new Lanche(0, nome, preco, caminhoImagem);

        String novoCaminho = lancheService.moverImagem(lanche, novaPasta);

        lanche.setCaminhoImagem(novoCaminho);
